...
export async function uploadVersionJSON(
  ...
  console.log('filtered', JSON.stringify(filteredAssets));
  ...
  for (const [idx, signatureFile] of signatureFiles.entries()) {
    ...
    // hasNativeArm = filteredAssets.find(
    //   (asset) => asset.arch === 'aarch64' && asset.bundle === 'app',
    // );
    // hasNativeX64 = filteredAssets.find(
    //   (asset) => asset.arch === 'x86_64' && asset.bundle === 'app',
    // );
