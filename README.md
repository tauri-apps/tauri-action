...
| `owner`                     |  false   | parameter to replace owner, needed to upload the release to another repository, required GITHUB_TOKEN in env                                 | string |                                               |
| `repo`                      |  false   | parameter to replace repo, needed to upload the release to another repository, required GITHUB_TOKEN in env                                  | string |                                               |
