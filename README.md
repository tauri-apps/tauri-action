...
| `isGitea`           |  false   | Whether to run in Gitea compatibility mode. Only set this if using in Gitea runner, since some API endpoints differ from GitHub                                                                                                                                       | bool   | false                                       |
